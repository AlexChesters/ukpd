...
## [8.0.0] - 2026-09-15
* Removes support for Node.js 20.x
* Adds support for Node.js 24.x
* Updates dependencies
* Updates forces methods return type

## [7.0.1] - 2025-08-05
* Fix incorrect `main` and `types` field in `package.json`
* Adds typescript examples
